...
public class PalaceJongmyoDetailImageDao {

	// result
	public List<PalaceJongmyoDetailImage> selectAll(Connection conn) {
		...
		try {
			...
			while (rs.next()) {
				...
				PalaceJongmyoDetailImage info = new PalaceJongmyoDetailImage(serial_number, gung_number,
	...
	public int insert(Connection conn, PalaceJongmyoDetailImage pjs) {
		try {
