...
public class PalaceJongmyoDetailMovieDao {

	// result
	public List<PalaceJongmyoDetailMovie> selectAll(Connection conn) {
		...
		try {
			...
			while (rs.next()) {
				...
				PalaceJongmyoDetailMovie info = new PalaceJongmyoDetailMovie(serial_number, gung_number,
	...
	public int insert(Connection conn, PalaceJongmyoDetailMovie pjs) {
		try {
