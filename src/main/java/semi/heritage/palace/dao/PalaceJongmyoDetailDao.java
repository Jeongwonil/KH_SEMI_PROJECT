...
public class PalaceJongmyoDetailDao {

	// result
	public List<PalaceJongmyoDetail> selectAll(Connection conn) {
		...
		try {
			...
			while (rs.next()) {
				...
				PalaceJongmyoDetail info = new PalaceJongmyoDetail(seq_pj_ss, serial_number, gung_number,
	...
	public int insert(Connection conn, PalaceJongmyoDetail pjs) {
		try {
