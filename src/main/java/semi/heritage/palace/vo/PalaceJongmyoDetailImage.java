...
public class PalaceJongmyoDetailImage {
	...
	public PalaceJongmyoDetailImage() {
		super();
	}

	public PalaceJongmyoDetailImage(int serial_number, int gung_number, int detail_code, String imageIndex,
