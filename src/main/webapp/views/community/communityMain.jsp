		...
		<table class="table" id="to_board" cellspacing="0">
			<tbody>
				...
				<tr>
					<td>
						<div class="etc1">
							<a style="text-decoration: none; color: black;" href="<%=path+"/community/view?type=T&boardNo="+b.getNo()%>"><%=b.getTitle() %></a>
						</div>
					</td>
					<td><%=b.getuName() %></td>
		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					<td>
						<div class="etc2">
							<a style="text-decoration: none; color: black;" href="<%=path+"/community/view?type=F&boardNo="+b.getNo()%>"><%=b.getTitle() %></a>
						</div>
					</td>
					<td><%=b.getuName() %></td>
					<%-- 게시판 추천은 없는 것이라서 임의로 작성일 넣음 --%>
